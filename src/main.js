...
async function loadNewPokemons() {
  ...
  `;
    ...
    pokemonContainer.innerHTML =
      "<p>Something went wrong while loading Pokemons</p>";
...
async function startBattle() {
  ...
  resultContainer.innerHTML = `<h2>The Winner is:<br>${winner.name.toUpperCase()} (${
    winner.attack
  } HP)</h2>`;

  //Añadir animación con CSS al Pokemon ganador
